    ...
    public class GarmentXlsSubconDLOComponentQueryHandlerTest : BaseCommandUnitTest
    {
        ...
        public async Task Handle_StateUnderTest_ExpectedBehavior()
        {
            ...
            _mockgarmentSubconCuttingRepository
                ...
                {
                    new GarmentServiceSubconCutting(guidSubconCutting, "subconNo", "subconType", new UnitDepartmentId(1), "unitCode", "unitName", DateTimeOffset.Now, true, new BuyerId(1), "buyerCode", "buyerName",new BuyerBrandId(1), "", "", new UomId(1), "uomUnit", 1).GetReadModel()

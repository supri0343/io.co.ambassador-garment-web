...
namespace Manufactures.Tests.Queries.GarmentExpenditureGoods
{
	public class MonitoringExpenditureGoodCommandHandlerTest : BaseCommandUnitTest
	{
		...
		public async Task Handle_StateUnderTest_ExpectedBehavior()
		{
			...
			//	{
			//		new GarmentPreparingItem(guidPrepareItem,1,new Domain.GarmentPreparings.ValueObjects.ProductId(1),"productCode","productName","designColor",1,new Domain.GarmentPreparings.ValueObjects.UomId(1),"uomUnit","fabricType",1,1,guidPrepare,"roSource","customsCategory").GetReadModel()
			//	}.AsQueryable());

...
{
    public class UpdateDatesGarmentSubconFinishingOutCommandHandler : ICommandHandler<UpdateDatesGarmentFinishingOutCommand, int>
    {
        private readonly IStorage _storage;
        private readonly IGarmentFinishingOutRepository _garmentFinishingOutRepository;

        public UpdateDatesGarmentSubconFinishingOutCommandHandler(IStorage storage)
        {
            _storage = storage;

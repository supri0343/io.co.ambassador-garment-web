...
namespace Manufactures.Application.GarmentMonitoringProductionSubconStockFlows.Queries
{
	public class GarmentMonitoringProductionStockFlowDto
	{
		...
		public GarmentMonitoringProductionStockFlowDto(GarmentMonitoringProductionStockFlowDto flowDto)
		{
			...
			this.QtyCuttingToPacking = flowDto.QtyCuttingToPacking;
			this.PriceCuttingToPacking = flowDto.PriceCuttingToPacking;
			...
			this.WipSewingToPacking = flowDto.WipSewingToPacking;
			this.WipSewingToPackingPrice = flowDto.WipSewingToPackingPrice;

...
{
	public class GarmentExpenditureGoodForAccountingQueryHandler : IQueryHandler<GetMonitoringExpenditureGoodForAccountingQuery, GarmentMonitoringExpenditureGoodListViewModel>
	{
        ...
        public GarmentExpenditureGoodForAccountingQueryHandler(IStorage storage, IServiceProvider serviceProvider)
		{
			_storage = storage;
		...
		public async Task<GarmentMonitoringExpenditureGoodListViewModel> Handle(GetMonitoringExpenditureGoodForAccountingQuery request, CancellationToken cancellationToken)
		{

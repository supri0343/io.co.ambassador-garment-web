...
{
    public class GarmentSubconExpenditureGoodReturnItemDto : BaseDto
    {
        public GarmentSubconExpenditureGoodReturnItemDto(GarmentSubconExpenditureGoodReturnItem garmentExpenditureGoodReturnItem)
        {

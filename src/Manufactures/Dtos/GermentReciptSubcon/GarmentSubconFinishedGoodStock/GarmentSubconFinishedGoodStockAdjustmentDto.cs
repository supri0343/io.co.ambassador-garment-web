...
namespace Manufactures.Dtos.GermentReciptSubcon.GarmentFinishedGoodStocks
{ 
	class GarmentSubconFinishedGoodStockAdjustmentDto : BaseDto
	{
		public GarmentSubconFinishedGoodStockAdjustmentDto(GarmentSubconFinishedGoodStock transaction)
		{

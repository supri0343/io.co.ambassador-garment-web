...
{
    public class GarmentSubconSewingInItemReadModel : ReadModelBase
    {
        public GarmentSubconSewingInItemReadModel(Guid identity) : base(identity)
        {
        }
        ...
        public Guid LoadingOutItemId { get; internal set; }
		...
		public virtual GarmentSubconSewingInReadModel GarmentSewingInIdentity { get; internal set; }
    }
}
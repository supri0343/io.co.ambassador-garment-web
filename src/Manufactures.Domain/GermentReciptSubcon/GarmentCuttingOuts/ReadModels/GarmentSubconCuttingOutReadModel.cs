...
{
    public class GarmentSubconCuttingOutReadModel : ReadModelBase
    {
        public GarmentSubconCuttingOutReadModel(Guid identity) : base(identity)
        {
        }
        ...
        public virtual List<GarmentSubconCuttingOutItemReadModel> GarmentSubconCuttingOutItem { get; internal set; }
    }
}

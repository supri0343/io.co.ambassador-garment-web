...
namespace Manufactures.Domain.GermentReciptSubcon.GarmentCuttingOuts.Commands
{
    ...
    public class PlaceGarmentSubconCuttingOutCommandValidator : AbstractValidator<PlaceGarmentSubconCuttingOutCommand>
    {
        public PlaceGarmentSubconCuttingOutCommandValidator()
        {

...
using Manufactures.Domain.GermentReciptSubcon.GarmentCuttingOuts.ValueObjects;
...
{
    public class UpdateGarmentSubconCuttingOutCommand : ICommand<GarmentSubconCuttingOut>
    {
        ...
        public class UpdateGarmentSubconCuttingOutCommandValidator : AbstractValidator<UpdateGarmentSubconCuttingOutCommand>
        {
            public UpdateGarmentSubconCuttingOutCommandValidator()
            {

...
{
    public class GarmentSubconExpenditureGoodReturn : AggregateRoot<GarmentSubconExpenditureGoodReturn, GarmentSubconExpenditureGoodReturnReadModel>
    {
        ...
        public GarmentSubconExpenditureGoodReturn(Guid identity, string returNo, string returType, string expenditureNo, string doNo, string urnNo, string bcNo, string bcType, UnitDepartmentId unitId, string unitCode, string unitName, string rONo, string article, GarmentComodityId comodityId, string comodityCode, string comodityName, BuyerId buyerId, string buyerCode, string buyerName, DateTimeOffset returDate, string invoice, string returDesc) : base(identity)
        {
            ...
            ReadModel = new GarmentSubconExpenditureGoodReturnReadModel(Identity)
            {
                ReturNo = ReturNo,
                ReturType = ReturType,
                ReturDate = ReturDate,
        ...
        public GarmentSubconExpenditureGoodReturn(GarmentSubconExpenditureGoodReturnReadModel readModel) : base(readModel)
        {
        ...
        protected override GarmentSubconExpenditureGoodReturn GetEntity()
        {
            return this;
        }
    }

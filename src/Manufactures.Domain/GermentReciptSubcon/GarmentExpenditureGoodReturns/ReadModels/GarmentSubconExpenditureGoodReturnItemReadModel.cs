...
{
    public class GarmentSubconExpenditureGoodReturnItemReadModel : ReadModelBase
    {
        public GarmentSubconExpenditureGoodReturnItemReadModel(Guid identity) : base(identity)
        {
        }
		...
		public virtual GarmentSubconExpenditureGoodReturnReadModel GarmentSubconExpenditureGoodReturn { get; internal set; }

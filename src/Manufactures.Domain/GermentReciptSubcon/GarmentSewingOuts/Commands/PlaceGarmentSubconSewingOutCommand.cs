...
using Manufactures.Domain.GermentReciptSubcon.GarmentSewingOuts.ValueObjects;
...
{
    public class PlaceGarmentSubconSewingOutCommand : ICommand<GarmentSubconSewingOut>
    {
        ...
        public List<GarmentSubconSewingOutItemValueObject> Items { get; set; }
        public bool IsSave { get; set; }
        public double Price { get; set; }

    }

    public class PlaceGarmentSubconSewingOutCommandValidator : AbstractValidator<PlaceGarmentSubconSewingOutCommand>
    {
        public PlaceGarmentSubconSewingOutCommandValidator()
        {
            ...
            RuleForEach(r => r.Items).SetValidator(new GarmentSubconSewingOutItemValueObjectValidator());
        }
    }

    class GarmentSubconSewingOutItemValueObjectValidator : AbstractValidator<GarmentSubconSewingOutItemValueObject>
    {
        public GarmentSubconSewingOutItemValueObjectValidator()
        {
            ...
            RuleForEach(r => r.Details).SetValidator(new GarmentSubconSewingOutDetailValueObjectValidator()).When(r => r.IsDifferentSize == true && r.IsSave == true);
            
        }
    }

    class GarmentSubconSewingOutDetailValueObjectValidator : AbstractValidator<GarmentSubconSewingOutDetailValueObject>
    {
        public GarmentSubconSewingOutDetailValueObjectValidator()
        {

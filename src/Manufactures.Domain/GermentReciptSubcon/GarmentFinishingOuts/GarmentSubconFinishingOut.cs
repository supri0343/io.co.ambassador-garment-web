...
{
    public class GarmentSubconFinishingOut : AggregateRoot<GarmentSubconFinishingOut, GarmentReceiptSubconFinishingOutReadModel>
    {
        ...
        public GarmentSubconFinishingOut(Guid identity, string finishingOutNo, UnitDepartmentId unitToId, string unitToCode, string unitToName, string finishingTo, DateTimeOffset finishingOutDate, string rONo, string article, UnitDepartmentId unitId, string unitCode, string unitName, GarmentComodityId comodityId, string comodityCode, string comodityName, bool isDifferentSize) : base(identity)
        {
            ...
            ReadModel = new GarmentReceiptSubconFinishingOutReadModel(Identity)
            {
                FinishingOutNo = FinishingOutNo,
                FinishingTo = FinishingTo,
        ...
        public GarmentSubconFinishingOut(GarmentReceiptSubconFinishingOutReadModel readModel) : base(readModel)
        {
        ...
        protected override GarmentSubconFinishingOut GetEntity()
        {
            return this;
        }
    }

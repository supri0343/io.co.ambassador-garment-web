...
{
    public class GarmentSubconFinishingOutItemValueObject : ValueObject
    {
        ...
        public List<GarmentSubconFinishingOutDetailValueObject> Details { get; set; }
        ...
        public GarmentSubconFinishingOutItemValueObject()
        {
        }

...
{
    public class GarmentReceiptSubconFinishingOutReadModel : ReadModelBase
    {
        public GarmentReceiptSubconFinishingOutReadModel(Guid identity) : base(identity)
        {
        }
		...
		public virtual List<GarmentReceiptSubconFinishingOutItemReadModel> GarmentFinishingOutItem { get; internal set; }

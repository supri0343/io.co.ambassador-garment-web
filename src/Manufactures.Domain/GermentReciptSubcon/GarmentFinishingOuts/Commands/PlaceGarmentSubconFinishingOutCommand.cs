...
using Manufactures.Domain.GermentReciptSubcon.GarmentFinishingOuts.ValueObjects;
...
{
    public class PlaceGarmentSubconFinishingOutCommand : ICommand<GarmentSubconFinishingOut>
    {
        ...
        public List<GarmentSubconFinishingOutItemValueObject> Items { get; set; }
        public bool IsSave { get; set; }
        public double Price { get; set; }

    }

    public class PlaceGarmentSubconFinishingOutCommandValidator : AbstractValidator<PlaceGarmentSubconFinishingOutCommand>
    {
        public PlaceGarmentSubconFinishingOutCommandValidator()
        {
            ...
            RuleForEach(r => r.Items).SetValidator(new GarmentSubconFinishingOutItemValueObjectValidator());
        }
    }

    class GarmentSubconFinishingOutItemValueObjectValidator : AbstractValidator<GarmentSubconFinishingOutItemValueObject>
    {
        public GarmentSubconFinishingOutItemValueObjectValidator()
        {
            ...
            RuleForEach(r => r.Details).SetValidator(new GarmentSubconFinishingOutDetailValueObjectValidator()).When(r => r.IsDifferentSize == true && r.IsSave == true);

        }
    }

    class GarmentSubconFinishingOutDetailValueObjectValidator : AbstractValidator<GarmentSubconFinishingOutDetailValueObject>
    {
        public GarmentSubconFinishingOutDetailValueObjectValidator()
        {

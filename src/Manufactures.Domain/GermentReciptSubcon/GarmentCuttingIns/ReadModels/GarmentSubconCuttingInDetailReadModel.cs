...
{
    public class GarmentSubconCuttingInDetailReadModel : ReadModelBase
    {
        public GarmentSubconCuttingInDetailReadModel(Guid identity) : base(identity)
        {
        }
		...
		public virtual GarmentSubconCuttingInItemReadModel GarmentCuttingInItem { get; internal set; }
    }
}

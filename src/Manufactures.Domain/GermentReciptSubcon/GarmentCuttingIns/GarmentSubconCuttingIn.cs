...
{
    public class GarmentSubconCuttingIn : AggregateRoot<GarmentSubconCuttingIn, GarmentSubconCuttingInReadModel>
    {
		...
		public GarmentSubconCuttingIn(Guid identity, string cutInNo, string cuttingType, string cuttingFrom, string rONo, string article, UnitDepartmentId unitId, string unitCode, string unitName, DateTimeOffset cuttingInDate, double fC) : base(identity)
        {
            ...
            ReadModel = new GarmentSubconCuttingInReadModel(Identity)
            {
                CutInNo = CutInNo,
                CuttingType = CuttingType,
                CuttingFrom= CuttingFrom,
        ...
        public GarmentSubconCuttingIn(GarmentSubconCuttingInReadModel readModel) : base(readModel)
        {
        ...
        protected override GarmentSubconCuttingIn GetEntity()
        {
            return this;
        }
    }

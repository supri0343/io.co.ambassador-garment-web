...
namespace Manufactures.Domain.GermentReciptSubcon.GarmentFinishedGoodStocks
{
    public class GarmentSubconFinishedGoodStock : AggregateRoot<GarmentSubconFinishedGoodStock, GarmentSubconFinishedGoodStockReadModel>
    {
		...
		public GarmentSubconFinishedGoodStock(Guid identity, string finishedGoodStockNo, string rONo, string article, UnitDepartmentId unitId, string unitCode, string unitName, GarmentComodityId comodityId, string comodityCode, string comodityName, SizeId sizeId, string sizeName, UomId uomId, string uomUnit, double quantity, double basicPrice, double price) : base(identity)
        {
			...
			ReadModel = new GarmentSubconFinishedGoodStockReadModel(Identity)
            {
                FinishedGoodStockNo = FinishedGoodStockNo,
                RONo = RONo,
                Article = Article,
        ...
        public GarmentSubconFinishedGoodStock(GarmentSubconFinishedGoodStockReadModel readModel) : base(readModel)
        {
        ...
        protected override GarmentSubconFinishedGoodStock GetEntity()
        {
            return this;
        }
    }

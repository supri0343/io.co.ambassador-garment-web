...
{
    public class GarmentSubconPackingInItemReadModel : ReadModelBase
    {
        public GarmentSubconPackingInItemReadModel(Guid identity) : base(identity)
        {
        }
        public Guid PackingInId { get; internal set; }
        ...
        public virtual GarmentSubconPackingInReadModel GarmentSubconPackingInIdentity { get; internal set; }
    }
}

...
{
    public class UpdateGarmentSubconPreparingCommand : ICommand<GarmentSubconPreparing>
    {
    ...
    public class UpdateGarmentPreparingCommandValidator : AbstractValidator<UpdateGarmentSubconPreparingCommand>
    {

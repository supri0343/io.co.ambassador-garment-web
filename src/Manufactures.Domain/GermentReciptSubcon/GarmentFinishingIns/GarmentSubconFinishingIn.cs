...
{
    public class GarmentSubconFinishingIn : AggregateRoot<GarmentSubconFinishingIn, GarmentSubconFinishingInReadModel>
    {
        ...
        public GarmentSubconFinishingIn(Guid identity, string finishingInNo, string finishingInType, UnitDepartmentId unitFromId, string unitFromCode, string unitFromName, string rONo, string article, UnitDepartmentId unitId, string unitCode, string unitName, DateTimeOffset finishingInDate, GarmentComodityId comodityId, string comodityCode, string comodityName, long doId, string doNo, string subconType,bool isApproved) : base(identity)
        {
            ...
            ReadModel = new GarmentSubconFinishingInReadModel(Identity)
            {
                FinishingInDate = FinishingInDate,
                FinishingInNo = FinishingInNo,
                FinishingInType= FinishingInType,
        ...
        public GarmentSubconFinishingIn(GarmentSubconFinishingInReadModel readModel) : base(readModel)
        {
        ...
        protected override GarmentSubconFinishingIn GetEntity()
        {
            return this;
        }
    }

...
{
    public class GarmentSubconFinishingInReadModel : ReadModelBase
    {
        public GarmentSubconFinishingInReadModel(Guid identity) : base(identity)
        {
        ...
        public virtual List<GarmentSubconFinishingInItemReadModel> Items { get; internal set; }

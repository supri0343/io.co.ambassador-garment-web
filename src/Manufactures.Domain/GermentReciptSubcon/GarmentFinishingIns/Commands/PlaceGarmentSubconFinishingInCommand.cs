...
using Manufactures.Domain.GermentReciptSubcon.GarmentFinishingIns.ValueObjects;
...
{
    public class PlaceGarmentSubconFinishingInCommand : ICommand<GarmentSubconFinishingIn>
    {
    ...
    class GarmentSubconFinishingInItemValueObjectValidator : AbstractValidator<GarmentSubconFinishingInItemValueObject>
    {
        public GarmentSubconFinishingInItemValueObjectValidator()
        {
            ...
            RuleFor(r => r.Quantity)
                .LessThanOrEqualTo(r => r.SewingOutRemainingQuantity)
                .OverridePropertyName("Quantity")
                .WithMessage(x => $"'Jumlah' tidak boleh lebih dari '{x.SewingOutRemainingQuantity}'.")

...
{
    public class GarmentSubconCuttingInRepository : AggregateRepostory<GarmentSubconCuttingIn, GarmentSubconCuttingInReadModel>, IGarmentSubconCuttingInRepository
    {
        public IQueryable<GarmentSubconCuttingInReadModel> Read(int page, int size, string order, string keyword, string filter)
        {
            var data = Query;
            ...
            data = QueryHelper<GarmentSubconCuttingInReadModel>.Filter(data, FilterDictionary);
            ...
            data = OrderDictionary.Count == 0 ? data.OrderByDescending(o => o.ModifiedDate) : QueryHelper<GarmentSubconCuttingInReadModel>.Order(data, OrderDictionary);
        ...
        protected override GarmentSubconCuttingIn Map(GarmentSubconCuttingInReadModel readModel)
        {
            return new GarmentSubconCuttingIn(readModel);
        }

        public IQueryable<object> ReadExecute(IQueryable<GarmentSubconCuttingInReadModel> query) {
